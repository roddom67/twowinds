 ...
 ***/
	$proyecto = 'twowinds';
	$proyectoNombre = 'Two Winds | Urquiza';
	
	/* Paginas */
	/* Home */
	$headTitulo['index'] = 'Urquiza | Two Winds';
	$headDesc['index'] = 'Two Winds - Urquiza. Mi lugar en el mundo. 54 11 5354.8000';
	$headKeywords['index'] = 'barrancas, barrio, luminosos, ambientees, edificio, moderno, ciudad, departamentos, inmobiliaria, arquitecto, desarrollo, gestión, inmobiliarios, gerenciamiento,edificios, vivienda, oficinas, concursos, construcción, planificación, obras, dirección, urquiza, two winds';
	
	$titulo['index'] = 'URQUIZA';
	$subtitulo['index'] = 'Mi lugar en el mundo';
